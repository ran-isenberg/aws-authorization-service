...
from cdk.authorization.api_construct import ApiConstruct
from cdk.authorization.constants import OWNER_TAG, SERVICE_NAME, SERVICE_NAME_TAG
from cdk.authorization.utils import get_construct_name, get_username
...
class ServiceStack(Stack):
    def __init__(self, scope: Construct, id: str, is_production_env: bool, **kwargs) -> None:
        ...
        self.api = ApiConstruct(
            self,
            get_construct_name(stack_prefix=id, construct_name='Auth'),
